...
public class MainActivity extends Activity {
    ...
    private static final int NOTI_THIRD = 1202;
...
//        if (text != null){
//            TextView tv = findViewById(R.id.custom_text);
//            tv.setText(text);
//        }
        ...
        if (remoteInput != null){
            ...
            System.out.println("logger output: " + text);
    ...
    public void sendNotification(int id, String title) {
        ...
        switch (id) {
            ...
            case NOTI_THIRD:
                nb = noti.getNotification3(title, "custom 3");
                break;
        }
        if (nb != null) {
            noti.notify(id, nb);
    ...
    class MainUi implements View.OnClickListener {
        ...
        private MainUi(View root) {
            ...
            root.findViewById(R.id.third_btn).setOnClickListener(this);
        }
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.btnA:
                    ...
                    break;
                case R.id.third_btn:
                    sendNotification(NOTI_THIRD, "my new title");
                default:
